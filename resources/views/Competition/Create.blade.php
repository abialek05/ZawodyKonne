      ...
      <div class="col-lg-6" style="margin: auto;">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <form method="POST" action="/competitions/create" onsubmit="return checkForm()">
              @csrf
              <div class="row mb-3">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="number" class="form-control validate" onchange="validateModel('Spots');" name="Spots" id="Spots" value="{{ $model->Spots }}">
                  <span id="Spots-error" class="text-danger"></span>
                </div>
              </div>
              <div class="row mb-3">
